<template>
  ...
  <a href="https://discord.gg/MJ8hhYQxtK" style="float:right;margin-right:5px;color:#333;font-size:15px;margin-top:15px;">Discord</a>
    ...
    <div class="start" style="padding-top:50%;">
       <button style=" padding: 12px 48px;background-color:black; box-shadow: 0 0 10px rgb(44 39 109 / 10%); border-radius:4px; cursor: pointer; border: 1px solid #0f5806; color:white " v-on:click="routerchange">Enter App</button>
    </div>
  </div>
</template>
